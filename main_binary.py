...
def main():
    ...
    try:
        ...
        normal_button.place(relheight=0.25, relwidth=0.3, relx=0.65, rely=0.15)
        ...
        business_button.place(relheight=0.25, relwidth=0.3, relx=0.65, rely=0.5)
